...
hla_mhc = pd.read_csv('./mhc_i/method/netmhcpan-4.1-executable/netmhcpan_4_1_executable/data/MHC_pseudo.dat', delim_whitespace=True, header=None)
...
trainset.to_csv('iedb_i/raw/iedb_trainset.csv', index=False)
testset.to_csv('iedb_i/raw/iedb_testset.csv', index=False)
